...
class Forearms_workouts extends StatefulWidget {
  @override
  _Forearms_workoutsState createState() => _Forearms_workoutsState();
}

class _Forearms_workoutsState extends State<Forearms_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('Forearms_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Forearms Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
