...
class Shoulder_workouts extends StatefulWidget {
  @override
  _Shoulder_workoutsState createState() => _Shoulder_workoutsState();
}

class _Shoulder_workoutsState extends State<Shoulder_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('Shoulders_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Shouders Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
