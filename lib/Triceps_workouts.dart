...
class Triceps_workouts extends StatefulWidget {
  @override
  _Triceps_workoutsState createState() => _Triceps_workoutsState();
}

class _Triceps_workoutsState extends State<Triceps_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('Triceps_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Triceps Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                      ...
                      child: GestureDetector(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            leading: Image.network(workouts[index]["image"], width: 100),
                            title: Text(
                              workouts[index]["name"],
