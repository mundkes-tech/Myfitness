...
class Back_workouts extends StatefulWidget {
  @override
  _Back_workoutsState createState() => _Back_workoutsState();
}

class _Back_workoutsState extends State<Back_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('back_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Back Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
