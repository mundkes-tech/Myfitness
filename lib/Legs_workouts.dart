...
class Legs_workouts extends StatefulWidget {
  @override
  _Legs_workoutsState createState() => _Legs_workoutsState();
}

class _Legs_workoutsState extends State<Legs_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('legs_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Legs Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
