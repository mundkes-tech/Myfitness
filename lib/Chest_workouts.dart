...
// import 'dart:math';
//
// class Chest_workouts extends StatefulWidget {
//   @override
//   _Chest_workoutsState createState() => _Chest_workoutsState();
// }
//
// class _Chest_workoutsState extends State<Chest_workouts> {
...
//     FirebaseFirestore.instance.collection('chest_workouts').get().then((querySnapshot) {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("Chest Workouts", style: TextStyle(color: Colors.white)),
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text(workout['name'] ?? "Exercise"),
//         backgroundColor: Colors.purple,
//       ),
//       body: Padding(
...
//           children: [
//             Center(
//               child: Image.network(workout["image"], height: 200),
//             ),
//             SizedBox(height: 20),
//             Text(
...
//             SizedBox(height: 5),
//             Text(workout["instructions"] ?? "No instructions available."),
//             Spacer(),
//             ElevatedButton(
//               onPressed: () {
//                 onComplete();
...
class _Chest_workoutsState extends State<Chest_workouts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Chest Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
