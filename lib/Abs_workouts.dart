...
class Abs_workouts extends StatefulWidget {
  @override
  _Abs_workoutsState createState() => _Abs_workoutsState();
}

class _Abs_workoutsState extends State<Abs_workouts> {
  ...
  Future<void> fetchWorkouts() async {
    FirebaseFirestore.instance.collection('abs_workouts').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Abs Workouts", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
